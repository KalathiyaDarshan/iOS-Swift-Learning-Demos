...
public extension UIView {
    ...
    */
    ...
    /**
     ...
     @param position The toast's position
     */
    func makeToastActivity(_ position: ToastPosition, canUserInteract: Bool = false) {
        // sanity
        ...
        self.isUserInteractionEnabled = canUserInteract
    }
    ...
    /**
     ...
     @param position The toast's center point
     */
    func makeToastActivity(_ position: CGPoint, canUserInteract: Bool) {
        // sanity
        if let _ = objc_getAssociatedObject(self, &ToastKeys.ActivityView) as? UIView {
            return
        }
    ...
    private func createToastActivityView() -> UIView {
        ...
        activityView.backgroundColor = #colorLiteral(red: 0.1449999958, green: 0.5139999986, blue: 0.6470000148, alpha: 1).withAlphaComponent(0.95) //style.backgroundColor
    ...
    */
    ...
    private func centerPointForPosition(_ position: ToastPosition, toast: UIView) -> CGPoint {
        ...
        case .bottom:
            return CGPoint(x: self.bounds.size.width / 2.0, y: (self.bounds.size.height - ((toast.frame.size.height / 2.0) + 80)) - padding)
        }
    }
}
...
public struct ToastStyle {
    ...
    */
    ...
    /**
     ...
     Default is 10.0.
    */
    public var horizontalPadding: CGFloat = 14.0
