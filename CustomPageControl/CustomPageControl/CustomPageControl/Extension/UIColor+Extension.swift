...
extension UIColor {
    ...
    // Helper to create UIColor from hex and opacity
    ...
    static func appBlue_0042EB() -> UIColor {
        return UIColor(hexString: "#0042EB")
    }
    ...
    static func appBlue_020E37() -> UIColor {   // changed
        return UIColor(hexString: "#020E37")
    }
    ...
    static func appRed_FF0000() -> UIColor {
    ...
    static func appBlack_1E1E1E() -> UIColor {
    ...
    static func appWhite_FFFFFF_Opacity_24() -> UIColor {
        return UIColor(hexString: "#FFFFFF").withAlphaComponent(0.24)
    }
